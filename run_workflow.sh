...
echo "--- Step 1: Get Focus Catchment ---"
docker run -it --rm -v $OUT_DIR:/out -e R_SCRIPT=get_focus_catchment.R d2k-toolbox "115" "/out/catchment.gpkg" "/out/countries.rds"
...
docker run -it --rm -v $OUT_DIR:/out -e R_SCRIPT=calculate_weighting.R d2k-toolbox "/out/censusgrid_catchment.rds" "/out/corine2018_cropped.rds" "/out/urban_values.rds" "/out/coryear2018.rds" "/out/clc_legend.rds" "/out/weight_table_final.rds"
...
# Step 9A: Dasymetric Refinement (Weighted, 2018)
echo "--- Step 9A: Dasymetric Refinement (Weighted, 2018) ---"
docker run -it --rm -v $OUT_DIR:/out -e R_SCRIPT=dasymetric_refinement.R d2k-toolbox "weighted" "/out/corine2018_valid.rds" "/out/coryear2018.rds" "/out/lau_2018_catchment.rds" "/out/2018.rds" "/out/catchment.gpkg" "/out/weight_table_final.rds" "/out/refinement_weighted_2018.rds" "/out/refinement_weighted_2018.tif" "/out/lau_cell_counts_weighted2018.rds"

# Step 9B: Dasymetric Refinement (Weighted, 2021)
echo "--- Step 9B: Dasymetric Refinement (Weighted, 2021) ---"
docker run -it --rm -v $OUT_DIR:/out -e R_SCRIPT=dasymetric_refinement.R d2k-toolbox "weighted" "/out/corine2018_valid.rds" "/out/coryear2018.rds" "/out/lau_2021_catchment.rds" "/out/2021.rds" "/out/catchment.gpkg" "/out/weight_table_final.rds" "/out/refinement_weighted_2021.rds" "/out/refinement_weighted_2021.tif" "/out/lau_cell_counts_weighted2021.rds"

# Step 9C: Dasymetric Refinement (Simple, 2021)
echo "--- Step 9C: Dasymetric Refinement (Simple, 2021) ---"
docker run -it --rm -v $OUT_DIR:/out -e R_SCRIPT=dasymetric_refinement.R d2k-toolbox "simple" "/out/corine2018_valid.rds" "/out/coryear2018.rds" "/out/lau_2021_catchment.rds" "/out/2021.rds" "/out/catchment.gpkg" "/out/weight_table_final.rds" "/out/refinement_simple_2021.rds" "/out/refinement_simple_2021.tif" "/out/lau_cell_counts_simple2021.rds"
...
echo "--- Step 11: Crop and Mask Raster (Overlapping Positive Pop x Catchment) ---"
...
docker run -it --rm -v $OUT_DIR:/out -e R_SCRIPT=process_create_visualizations.R d2k-toolbox "/out/weight_table_final.rds" "/out/clc_legend.rds" "/out/coryear2018.rds" "/out/visual_input_weights_histogram.html" "/out/lau_cell_counts_weighted2018.rds" "/out/visual_cor_distribution_across_lau.html" "/out/censusgrid.rds" "/out/evaluate_weighted_2021.rds" "/out/catchment.gpkg" "/out/visual_census_grid_map.html" "/out/2018.rds" "/out/lau_2018_catchment.rds" "/out/visual_lau_in_catch_focus_map.html" "/out/lau_2021_catchment.rds" "/out/visual_lau_in_catch_reference_map.html" "/out/corine2018_valid.rds" "/out/visual_corineCLC_valid_map.html" "/out/corineCLC2018overlappingPositivePop2021.rds" "/out/visual_corineCLCoverlappingPosCensusgrid_map.html" "/out/refinement_weighted_2021.rds" "/out/visual_refinement_map.html" "/out/visual_error_map.html" 50 10 "/out/visual_binaryPercError_map.html" "/out/visual_histogram_errorsDistributedOnDensClasses.html" "/out/metrics_weighted.rds" "/out/metrics_simple.rds" "/out/visual_histogram_metrics.html"
